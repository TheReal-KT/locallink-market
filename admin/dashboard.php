...
$pageDescription = 'Admin moderation and marketplace operations.';
...
<section class="dashboard-layout">
  <aside class="dashboard-sidebar">
    ...
    <a href="<?php echo htmlspecialchars(app_url('admin/dashboard.php')); ?>">Reports</a>
  ...
  <div class="dashboard-main">
    ...
    <div class="dashboard-callout">
      <span>Marketplace controls</span>
      <p>Review seller applications, flagged products, user roles, and support activity from this workspace.</p>
    </div>
    <div class="table-wrap">
      <table>
        ...
        <tbody>
          <tr><td>Thabo N.</td><td>Seller</td><td><span class="badge">Pending review</span></td><td>Review</td></tr>
